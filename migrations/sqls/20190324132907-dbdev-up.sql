...
CREATE TABLE IF NOT EXISTS contact (
  ...
  zip varchar(32),
  state varchar(2),
  owned ENUM('Renter','Homeowner','Live with family/friends'), /*Dweling ownership type, rent or owned(Y/N)*/
  dateAdded DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS demographics (
  ...
  weeklyAvgHoursWorked ENUM("20 or less","21 to 35","36 to 40","41 or more"), /*Can be null if not employed*/  
...
/*Inatake Services is a 1:M intakeData:IntakeServices*/
